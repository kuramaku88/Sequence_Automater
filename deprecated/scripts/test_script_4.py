...
### Commands for Module_DIO_1
		hvis.dio_send_trigger('Turn on triggers', Module_DIO_1, ['A0', 'A6', 'A8'], on, 10)
		hvis.dio_send_trigger('Turn off triggers', Module_DIO_1, ['A0'], off, 15000.0)
		hvis.dio_send_trigger('Turn on triggers', Module_DIO_1, ['A11'], on, 5000.0)
		hvis.dio_send_trigger('Turn off triggers', Module_DIO_1, ['A11'], off, 110000.0)
		hvis.dio_send_trigger('Turn off triggers', Module_DIO_1, ['A6', 'A8'], off, 790500.0)
...
### Commands for Module_DIO_2
		hvis.dio_send_trigger('Turn on triggers', Module_DIO_2, ['B0', 'B1'], on, 10)
		hvis.dio_send_trigger('Turn off triggers', Module_DIO_2, ['B0', 'B1'], off, 1000000.0)
