...
### Commands for Module_DIO_2
		...
		hvis.dio_sweep('Sweeping [B2, B3]', Module_DIO_2, ['B2', 'B3'], 890.0)
		hvis.dio_sweep('Sweeping [B4]', Module_DIO_2, ['B4'], 88920.0)
		hvis.dio_sweep('Sweeping [B5]', Module_DIO_2, ['B5'], 109920.0)
		hvis.dio_send_trigger('Turn off triggers: Hello', Module_DIO_2, ['B0', 'B1'], off, 800000.0)
