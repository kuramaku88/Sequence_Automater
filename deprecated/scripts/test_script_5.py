...
### Commands for Module_DIO_1
		hvis.dio_send_trigger('Turn on triggers: [A0, A6, A8]', Module_DIO_1, ['A0', 'A6', 'A8'], on, 10)
		hvis.dio_send_trigger('Turn off triggers [A0]', Module_DIO_1, ['A0'], off, 15000.0)
		hvis.dio_send_trigger('Turn off triggers [A6, A8]', Module_DIO_1, ['A6', 'A8'], off, 905500.0)
		hvis.dio_send_trigger('Turn on triggers [A0, A9]', Module_DIO_1, ['A0', 'A9'], on, 1000.0)
		hvis.dio_send_trigger('Turn off triggers [A0, A9]', Module_DIO_1, ['A0', 'A9'], off, 70000.0)
		hvis.dio_send_trigger('Turn on triggers [A7]', Module_DIO_1, ['A7'], on, 500.0)
		hvis.dio_send_trigger('Turn off triggers [A7]', Module_DIO_1, ['A7'], off, 7500.0)
### Commands for Module_DIO_2
		hvis.dio_send_trigger('Turn on triggers: [B0, B1]', Module_DIO_2, ['B0', 'B1'], on, 10)
		hvis.dio_send_trigger('Turn off triggers [B0, B1]', Module_DIO_2, ['B0', 'B1'], off, 1000000.0)
