...
### Commands for Module_DIO_2
		hvis.dio_send_trigger('Turn on triggers: Hello', Module_DIO_2, ['B0', 'B1'], on, 10000.0)
		hvis.dio_sweep('Sweeping [B2, B3]', Module_DIO_2, ['B2', 'B3'], 1, 0.0, 0.01, 890.0)
		hvis.dio_sweep('Sweeping [B4]', Module_DIO_2, ['B4'], 2, 0.0, 0.01, 88920.0)
		hvis.dio_sweep('Sweeping [B5]', Module_DIO_2, ['B5'], 3, 0.0, 0.01, 99920.0)
		hvis.dio_send_trigger('Turn off triggers: Hello', Module_DIO_2, ['B0', 'B1'], off, 810000.0)
